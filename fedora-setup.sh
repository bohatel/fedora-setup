...
wget https://raw.githubusercontent.com/bohatel/fedora-setup/master/fedora.packages
wget https://raw.githubusercontent.com/bohatel/fedora-setup/master/bashrc.aliases
...
#Using KDE so this is not needed 
